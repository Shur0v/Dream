...
export default function Info() {
  ...
  return (
    <section className="father w-full py-20 bg-white" role="region" aria-labelledby="product-info-heading" data-layer="father">
      {/* father = full width product info section */}
      
      <div className="daughter w-full max-w-[1320px] mx-auto" data-layer="daughter">
        {/* daughter = design holder for entire product info section */}
        
        <div className="layer-1 space-y-6" data-layer="1">
          {/* layer-1 = main content container */}
          
          <div className="layer-2" data-layer="2">
            {/* layer-2 = product title container */}
            
            <div className="layer-3" data-layer="3">
              {/* layer-3 = title wrapper */}
              
              <div className="layer-4" data-layer="4">
                {/* layer-4 = product title */}
                <h1 className="text-3xl font-bold text-gray-900 mb-2" id="product-info-heading">{product.name}</h1>
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = pricing container */}
            
            <div className="layer-3 flex items-center gap-3" data-layer="3">
              {/* layer-3 = pricing wrapper */}
              
              <div className="layer-4" data-layer="4">
                {/* layer-4 = pricing display */}
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = description container */}
            
            <div className="layer-3" data-layer="3">
              {/* layer-3 = description wrapper */}
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = features container */}
            
            <div className="layer-3" data-layer="3">
              {/* layer-3 = features wrapper */}
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = variants container */}
            
            <div className="layer-3" data-layer="3">
              {/* layer-3 = variants wrapper */}
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = quantity container */}
            
            <div className="layer-3" data-layer="3">
              {/* layer-3 = quantity wrapper */}
              
              <div className="layer-4" data-layer="4">
                {/* layer-4 = quantity controls */}
          ...
          <div className="layer-2" data-layer="2">
            {/* layer-2 = action buttons container */}
            
            <div className="layer-3 flex gap-4" data-layer="3">
              {/* layer-3 = action buttons wrapper */}
