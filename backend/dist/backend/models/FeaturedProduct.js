...
const FeaturedProductSchema = new mongoose_1.Schema({
...
const FeaturedProductModel = mongoose_1.default.models.FeaturedProduct || mongoose_1.default.model('FeaturedProduct', FeaturedProductSchema);
exports.default = FeaturedProductModel;
