          ...
          {products.map((product, index) => (
              ...
              <div className="layer-13 self-stretch flex flex-col justify-start items-start" data-layer="13">
                ...
                <div className="layer-14 self-stretch pt-4 pb-5 flex flex-col justify-center items-start gap-3" data-layer="14">
                  ...
                  {/* Rating and Reviews */}
                  <div className="layer-21 flex flex-col md:flex-row md:inline-flex justify-start items-start md:items-center gap-1.5" data-layer="21">
                    ...
                    <div className="layer-23 hidden md:block text-center justify-start text-neutral-400 text-sm font-normal font-['Poppins'] leading-relaxed whitespace-nowrap" data-layer="23">
