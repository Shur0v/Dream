...
export default function AddProductForm({ onBack, onSave }: AddProductFormProps) {
  ...
  const [distribution, setDistribution] = useState<Distribution>('Best selling');
      ...
      <div className="w-full p-4 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col gap-2.5">
        <div className="self-stretch flex flex-col justify-start items-start gap-8">
          ...
          <div className="w-full flex flex-col gap-6">
              ...
              <div className="w-full flex flex-col gap-2.5">
                ...
                <div className="w-full h-14 px-5 py-3.5 rounded-md outline outline-1 outline-offset-[-1px] outline-gray-200 inline-flex items-center gap-2.5">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={form.isVerifiedSeller ?? false}
                      onChange={(e) => handleChange('isVerifiedSeller', e.target.checked)}
                      className="w-4 h-4 text-fuchsia-500 rounded"
                    />
                    <span className="text-zinc-900 text-base font-normal font-['Poppins']">Mark as verified seller</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            {/* Ratings & Reviews */}
            <div className="w-full pb-6 border-b flex flex-col gap-6">
              <h3 className="text-lg font-semibold text-zinc-900 font-['Poppins']">Ratings & Reviews</h3>
                ...
                <div className="w-full flex flex-col gap-2.5">
                  ...
                  <div className="w-full h-14 px-5 py-3.5 rounded-md outline outline-1 outline-offset-[-1px] outline-gray-200 inline-flex items-center gap-2.5">
                    <input
                      ...
                      min="0"
                      value={form.reviews ?? ''}
                      onChange={(e) => handleChange('reviews', e.target.value ? parseInt(e.target.value) : undefined)}
                      placeholder="0"
                      className="w-full bg-transparent outline-none text-zinc-900 text-base font-normal font-['Poppins']"
                    />
                  </div>
